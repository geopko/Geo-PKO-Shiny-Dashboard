...
## About this website
This website and interactive visualisations were created by Nguyen Ha, Lou van Roozendaal, and Tanushree Rao (research assistants at the Department of Peace and Conflict Research, Uppsala University). You can learn more about the script, written in RStudio, used to produce this application [on GitHub](http://). The following R packages were used: magrittr, rvest, readxl, dplyr, maps, ggplot2, RColorBrewer, leaflet, geojsonio, shiny, shinyWidgets, shinydashboard, shinythemes, tidyr, sf, stringr, lubridate, DT, GADMTools, Cairo, ggrepel, forcats, gifski, png, gganimate, scales, ggnewscale, shinycssloaders, purrr, foreign, knitr, and htmltools.
